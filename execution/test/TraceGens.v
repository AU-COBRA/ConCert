...
Section TraceGens.
  ...
  Fixpoint trace_blocks {from to} (trace : ChainTrace from to)
    ...
    match trace with
    | snoc trace' (BlockchainBase.step_block _ _ header _ _ _ _ _ as step) =>
  ...
  Fixpoint trace_states_step_block {from to} (trace : ChainTrace from to) : list ChainState :=
    match trace with
    | snoc trace' (BlockchainBase.step_block _ _ _ _ _ _ _ _ as step) =>
  ...
  Fixpoint trace_states_step_action {from to} (trace : ChainTrace from to)
    ...
    match trace with
    | snoc trace' (BlockchainBase.step_action _ _ act _ new_acts _ _ _ as step) =>
