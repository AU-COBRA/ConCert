...
Fixpoint indexify (l : list (name * nat)) (e : expr) : expr :=
  ...
  | eTy ty => eTy (indexify_type l ty) (* TODO : do we want to convert to the nameless repr here? *)
  end.
...
Module Psubst.
  ...
  Fixpoint erename (r : nat -> nat) (e : expr) : expr :=
    ...
    | eTyLam nm b => eTyLam nm (erename (↑1 ∘ r) b)
    ...
    | eTy _ => e (* should we do something here? *)
    end.
