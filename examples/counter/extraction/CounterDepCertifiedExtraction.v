...
Check ConCert_Examples_Counter_extraction_CounterDepCertifiedExtraction_Counter_counter_partially_applied_expanded_convertible.
(* ConCert_Extraction_Examples_CounterDepCertifiedExtraction_Counter_counter_partially_applied_expanded_convertible
     : counter_partially_applied =
       ConCert_Extraction_Examples_CounterDepCertifiedExtraction_Counter_counter_partially_applied_expanded *)
...
Definition COUNTER_PARTIAL_EXPANDED_MODULE : LiquidityMod msg _ (Z × address) storage operation :=
  {| (* a name for the definition with the extracted code *)
     ...
     (* the main functionality *)
     lmd_receive := ConCert_Examples_Counter_extraction_CounterDepCertifiedExtraction_Counter_counter_partially_applied_expanded;
...
Redirect "../extraction/examples/extracted-code/liquidity-extract/CounterDepCertifiedExtraction.liq" Compute liquidity_counter.
