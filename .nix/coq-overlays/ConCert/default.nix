{ lib, mkCoqDerivation, which, coq
  , metarocq-erasure, bignums, QuickChick, stdpp, TypedExtraction
  , version ? null }:
...
with lib; mkCoqDerivation {
  ...
  propagatedBuildInputs = [ coq.ocamlPackages.findlib metarocq-erasure bignums QuickChick stdpp TypedExtraction ];
